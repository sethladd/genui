  ...
  group('ListHotelsTool', () {
    group('HotelListing', () {
      test('fromJson and toJson', () {
        ...
        final HotelListing listing = HotelListing.fromJson(json);
    ...
    group('HotelSearchResult', () {
      test('fromJson and toJson', () {
        ...
        final HotelSearchResult searchResult = HotelSearchResult.fromJson(json);
    ...
    group('ListHotelsTool', () {
      test('invoke calls onListHotels and returns correct JSON', () async {
        ...
        final JsonMap result = await tool.invoke(args);
